...
class Search extends React.Component {
  /**
    ...
    * @param  {Array} techList - the full list of technologies
  ...
  */
  ...
  /**
    ...
    * @param  {Object} item - the selected lunr search index item
    * @param  {Object} query - the selected items to search for
    * @param  {Array} prod - the products key/pair with all info
    * @param  {Object} tech - the tech key/pair with the queues
  ...
  */
  ...
  /** @constructor state
    * @member {Array} filtered - the filtered search suggestions
    * @member {Object} query - the terms being searched for
    * @member {Object} results - info to be displayed in results
  */
  constructor(props) {
    super(props)
    this.state = {
  ...
  */
  ...
  /**
    * Event handler for the clicking on a search suggestion
