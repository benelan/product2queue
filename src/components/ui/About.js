      ...
      <Modal isOpen={modal} toggle={toggle} className={className}>
        ...
        <ModalBody>
          ...
          then the results will be returned on the right of the web page.</li>
            <li>You can reset the search field and technology by clicking the <b>clear</b> button on the top-right corner. </li>
            <li>Please make sure to review the transfer resources before transferring a case.</li>
          </ul>

          If you have any questions about the products our queues, feel free to contact the <a href="mailto:supt-readinessleads@esri.com?subject=Product%20Supportability%20Question"> Readiness Leads</a>. Additionally, please report any issues or bugs to the <a href="mailto:belan@esri.com?cc=lxie@esri.com&subject=Product%20App%20Issue">Developers</a>.
        </ModalBody>
        <ModalFooter>
